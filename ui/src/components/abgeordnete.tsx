...
import { Deputy, Party, Region, State } from '../models'
import { getDeputies, getStatesAndRegions } from '../api'
...
import {
  ...
  MenuItem, Paper,
  Select,
  SelectChangeEvent, TableBody, TableCell,
  TableContainer, TableHead, TableRow,
  Typography,Table,Grid
} from "@mui/material";
  ...
  return (
    <>
      ...
      <TableContainer component={Paper}>
        ...
        <Grid item xs={4}>
          <div style={{  justifyContent: 'end', paddingRight: ' 25px', paddingTop: "5px", paddingBottom: "40px", display: "flex"}}>
